...
| VAL-002 | Lid-driven cavity | Centerline profiles within 2% of Ghia et al. | XFAIL (collocated at 40x40 against ghia_1982_re100_r2: u 0.0408, v 0.0511; the 21% v error once recorded here was against a corrupted table, see the ECR-001 erratum; the staggered solver is validated at steps 7 and 8) |
